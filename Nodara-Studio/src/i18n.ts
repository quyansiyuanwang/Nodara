...
const EN: Record<string, string> = {
  ...
  "actions.run": "Run",
  "actions.runDetail": "Run the workflow. A paused run is continued instead.",
  "actions.restart": "Restart",
  "actions.restartDetail": "Cancel the active run and start the workflow again.",
  "actions.runWithVariables": "Variables…",
  "actions.runWithVariablesDetail": "Set per-run values before starting.",
  "actions.pause": "Pause",
  "actions.pauseDetail": "Pause after the current node finishes.",
  "actions.resume": "Resume",
  "actions.resumeDetail": "Continue the paused run.",
  "actions.step": "Step",
  "actions.stepDetail": "Run one node. Starts paused when no run is active.",
  "actions.cancel": "Cancel",
  "actions.cancelDetail": "Stop the active run.",
  "actions.runOffline": "the runtime is unreachable; start it and run again",
  "actions.runLocalProblems": "fix the workflow problems listed in Problems first",
  "actions.runValidationProblems": "validation did not pass; fix the Problems tab first",
  ...
  "inspector.resetAppearance": "Use theme color",
  ...
  "event.log": "log",
  "event.inputs": "Node input snapshot",
  "event.outputs": "Node outputs",
  "event.variablesAfter": "Variables after node",
  "event.transferredValue": "Transferred value",
  "event.paused": "paused",
  ...
  "agent.apiKeyHint": "API keys are stored per Profile in Windows Credential Manager and never written to localStorage, workflow JSON or logs.",
  "agent.visionRuntimeHint": "Continued sessions attach the previous run's screenshots as native image inputs. Use a vision-capable model when workflows capture the screen.",
  ...
  "audit.allRuns": "All runs",
  "audit.expand": "Expand audit",
  "audit.collapse": "Collapse audit",
  "audit.approvals": "Approvals",
  "audit.denials": "Denials",
  "audit.failures": "Failures",
  "audit.executionGraph": "Execution graph",
  "audit.noGraph": "No workflow snapshot is available for this run.",
  "audit.timeline": "Event timeline",
  "audit.recentEvents": "Recent records",
  "audit.detail": "Details",
  "audit.selectHint": "Select a node or timeline record to inspect details.",
  "audit.records": "Records",
  "audit.runs": "Runs",
  "audit.nodeState.pending": "pending",
  "audit.nodeState.running": "running",
  "audit.nodeState.success": "success",
  "audit.nodeState.failed": "failed",
...
const ZH: Record<string, string> = {
  ...
  "actions.validate": "校验",
  "actions.run": "运行",
  "actions.runDetail": "运行工作流；若运行已暂停则继续执行。",
  "actions.restart": "重新运行",
  "actions.restartDetail": "取消当前运行并重新开始该工作流。",
  "actions.runWithVariables": "运行参数…",
  "actions.runWithVariablesDetail": "启动前设置本次运行参数。",
  "actions.pause": "暂停",
  "actions.pauseDetail": "当前节点完成后暂停。",
  "actions.resume": "继续",
  "actions.resumeDetail": "继续已暂停的运行。",
  "actions.step": "单步",
  "actions.stepDetail": "执行一个节点；空闲时会先以暂停状态启动。",
  "actions.cancel": "取消",
  "actions.cancelDetail": "停止当前运行。",
  "actions.runOffline": "运行时不可达；请先启动运行时再运行",
  "actions.runLocalProblems": "请先修复“问题”面板中列出的工作流问题",
  "actions.runValidationProblems": "校验未通过；请先修复“问题”面板中的错误",
  "actions.refresh": "刷新",
  "actions.open": "打开",
  ...
  "inspector.resetAppearance": "恢复主题颜色",
  ...
  "event.inputs": "节点输入快照",
  "event.outputs": "节点输出",
  "event.variablesAfter": "节点后变量",
  "event.transferredValue": "传输值",
  "event.paused": "已暂停",
  "event.resumed": "已继续",
  "event.cancelled": "已取消",
  "event.completed": "已完成",
  ...
  "agent.expandWorkspace": "展开工作区",
  "agent.collapseWorkspace": "收起工作区",
  "agent.providerName": "配置名称",
  "agent.addProfile": "新增配置",
  "agent.removeProfile": "删除配置",
  "agent.promptTemplates": "提示词模板",
  "agent.addTemplate": "新增模板",
  "agent.noTemplates": "尚无提示词模板。",
  "agent.templateInstructions": "附加指令",
  "agent.extraInstructions": "每轮都会附加的额外指令……",
  "agent.stop": "停止",
  "agent.liveDraft": "模型实时草稿",
  "agent.waitingForDraft": "等待模型返回第一个 token……",
  "agent.cancelled": "已停止生成",
  "agent.phasePlanning": "规划中",
  "agent.validationPassed": "验证通过",
  "agent.validationFailed": "验证失败",
  "agent.repairRound": "第 {attempt} 轮修复",
  "agent.runFinished": "运行结束",
  "agent.planDiff": "计划变更",
  "agent.noDiff": "本轮计划没有修改工作流。",
  "agent.diffNodesAdded": "新增节点",
  "agent.diffNodesChanged": "修改节点",
  "agent.diffNodesRemoved": "删除节点",
  "agent.diffEdgesAdded": "新增连线",
  "agent.diffEdgesChanged": "修改连线",
  "agent.diffEdgesRemoved": "删除连线",
  "agent.trace": "决策 Trace",
  "agent.reusePrompt": "再次使用",
  "agent.retry": "重试",
  "agent.newChat": "新建会话",
  ...
  "agent.model": "模型",
  "agent.apiKey": "API Key",
  "agent.apiKeyHint": "API Key 按 Profile 写入 Windows 凭据管理器，不写 localStorage、workflow JSON 或日志。",
  "agent.visionRuntimeHint": "继续会话时会把上一次运行的截图作为原生图片输入发送；涉及屏幕截图的流程请使用支持视觉的模型。",
  "agent.timeout": "超时（毫秒）",
  ...
  "audit.denials": "拒绝",
  "audit.failures": "失败",
  "audit.executionGraph": "执行图",
  "audit.noGraph": "该运行没有可用的工作流快照。",
  "audit.timeline": "事件时间线",
  "audit.recentEvents": "最近记录",
  "audit.detail": "详情",
  "audit.selectHint": "选择节点或时间线记录查看详情。",
  "audit.records": "记录",
  "audit.runs": "运行",
  "audit.nodeState.pending": "待执行",
  "audit.nodeState.running": "运行中",
  "audit.nodeState.success": "成功",
  "audit.nodeState.failed": "失败",
  "audit.empty": "尚无审计记录。",
