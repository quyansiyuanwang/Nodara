...
const EN: Record<string, string> = {
  ...
  "canvas.hint": "Click to add at the centre, or drag a palette item to an exact canvas position. Click an output then an input to connect, or drag between ports. Right-click or press Delete to remove the selected item.",
...
const ZH: Record<string, string> = {
  ...
  "canvas.hint": "单击节点可添加到画布中央，也可拖到指定位置。可先点击输出端口再点击输入端口，或直接拖动连接。右键或按 Delete 删除所选项。中键拖动可平移画布，滚轮可缩放。",
  "canvas.zoomIn": "放大",
  "canvas.zoomOut": "缩小",
