...
import schemaText from "../../../Nodara-Core/schema/workflow.schema.json?raw";

/** A document inside `examples/`, where the relative `$schema` is valid. */
const DOCUMENT_URI = "file:///repo/examples/probe.json";
/** What `../Nodara-Core/schema/workflow.schema.json` resolves to. */
const SCHEMA_URI = "file:///repo/Nodara-Core/schema/workflow.schema.json";
