...
pub struct PluginClient {
    ...
    nodes: Vec<rf_schema::NodeDescriptor>,
}
...
impl PluginClient {
    ...
    pub fn from_transport(
        ...
        if rf_schema::version::major_of(&initialized.protocol_version)
    ...
    pub fn descriptors(&self) -> &[rf_schema::NodeDescriptor] {
        &self.nodes
    }
    ...
    ) -> PluginResult<Vec<rf_schema::NodeDescriptor>> {
