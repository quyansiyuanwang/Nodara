...
use rf_core::policy::CapabilityRequest;
use rf_schema::{
...
impl AgentSessionStore {
    ...
    pub fn upsert(&self, session: AgentSession) -> AgentSession {
        ...
        session.updated_at_ms = rf_schema::event::now_ms();
        self.inner
            .lock()
            .sessions
    ...
    pub fn raise_and_wait(
        ...
        let (approval_id, waiter) = {
            ...
            let approval = ApprovalRequest {
                ...
                requested_at_ms: rf_schema::event::now_ms(),
    ...
    pub fn decide(
        ...
        let (session, waiter) = {
            ...
            approval.decided_at_ms = Some(rf_schema::event::now_ms());
...
mod tests {
    ...
    fn plan_preview_drives_the_status() {
        let store = AgentSessionStore::new(Duration::from_millis(30));
        let session = store.create("thing", "mock");
        let mut workflow = rf_schema::Workflow::new("wf");
